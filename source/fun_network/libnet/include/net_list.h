...
#ifndef list_offset
#define list_offset(type,member) ((long)&(((type *)0)->member))
#endif
...
#define CREATE_LIST_HEAD(name)  struct list_head name = LIST_HEAD_INIT(name)

/**
 * @brief init_list_head 初始化一个list
 * @param list
 */
...
#define	list_entry(ptr, type, field)	list_container_of(ptr, type, field)
