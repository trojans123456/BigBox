...
/* maybe Two to the power */
int ring_buffer_init_( fifo_t* ring_buffer, uint8_t* buffer, uint32_t size )
{
  if (ring_buffer)
  {
...
int ring_buffer_consume( fifo_t* ring_buffer, uint32_t bytes_consumed )
{
